<?PHP
	$userProfil = DB::table('mst_karyawan')
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown user" id="header-user">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<span class="username">Hallo, {{ $userProfil->karyawan_nama }}</span>
						...
						<ul class="dropdown-menu">
							...
							<li><a href="javascript:;" onclick="location.href='//localhost:8000/logout'"><i class="fa fa-power-off"></i> Log Out</a></li>
						</ul>
					</li>
